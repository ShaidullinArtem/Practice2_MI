...
class EditServiceScreen(QMainWindow):
    def __init__(self, *, is_admin: bool = False, servie: ServiceModel = None):
        ...
        self.ui.service_discount_lineEdit.setText(str(int(self.service.discount * 100) if isinstance(self.service.discount, decimal.Decimal) else int(self.service.discount)))
